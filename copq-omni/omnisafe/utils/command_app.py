...
def train(  # pylint: disable=too-many-arguments
    ...
    Examples:
        .. code-block:: bash
            ...
            python -m omnisafe train --algo COPQ --env_id SafetyPointGoal2-v0 --parallel 1 \
    ...
    Examples:
        .. code-block:: bash
            ...
            python -m omnisafe benchmark --exp_name exp-1 --num_pool 1 \
                --config_path ./configs/off-policy/COPQ.yaml --log_dir ./runs
...
def evaluate_model(
    ...
    Examples:
        .. code-block:: bash
            ...
            python -m omnisafe eval --result_dir ./runs/COPQ-{SafetyPointGoal2-v0} --num_episode 10 \
...
def train_config(
    ...
    Examples:
        .. code-block:: bash
            ...
            python -m omnisafe train_config --config_path ./configs/off-policy/COPQ.yaml \
                --log_dir ./runs
